...
def build_admission_prompt() -> ChatPromptTemplate:
    return ChatPromptTemplate.from_messages([
        (
            ...
            "  * Whenever you state specific admission eligibility criteria, entry test weightages, closing merit percentages, deadlines, or fees from the Context Information, cite the source using numbered citations like `[1]`, `[2]` corresponding to the context sources.\n"
            "  * DO NOT fabricate or hallucinate dates, aggregate formulas, or closing cutoffs. If a specific cutoff or figure is NOT verified in the Context Information or History, explicitly advise the student to check the university's official admissions portal for that particular year.\n"
            "  * Ground all recommendations strictly in the verified context.\n"
